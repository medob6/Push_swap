...
SRC_BONUS= checker.c utils/libft_utils2.c utils/get_next_line.c utils/get_next_line_utils.c  stack_a_utils.c  stack_a_b_utils.c  stack_b_utils.c parser.c  utils/split.c push_swap_utils.c sort_array.c parser.c push_swap_utils2.c
NAME= push_swap
BONUS= checker
